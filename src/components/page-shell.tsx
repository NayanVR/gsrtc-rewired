			...
			<main className="flex min-h-[60vh] flex-col" id="main">
				<div className="mesh-hero">
					<div className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
						...
						{blurb ? (
							<p className="mt-3 max-w-2xl text-lg text-white/80">{blurb}</p>
						) : null}
					</div>
				</div>
						...
						{children ?? (
							<div className="rounded-3xl border border-ink-100 bg-surface p-8 shadow-card">
								<p className="text-ink-600 leading-relaxed">
									This page is part of the GSRTC redesign concept. The full
									experience is on its way — check back soon.
								</p>
								<Link
